...
public class Camera {
	...
	protected void mouseControl(Mouse mouse) {
		mouse.tick();
	...
	protected void keyboardControl(Keyboard key) {
	...
	public Vector3f getRayCastPoint() {
		if (Render3D.rayCastPoint != null) {
			return Render3D.rayCastPoint;
		}
		return null;
	}
