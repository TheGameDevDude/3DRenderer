...
public class Clipping {
	...
	public void clipNearZPlane(Triangle triangle, float NEAR) {
		...
		if (triangle.a.position.Zpos >= NEAR && triangle.b.position.Zpos >= NEAR && triangle.c.position.Zpos >= NEAR) {
			...
			Vertex AB = new Vertex(new Vector3f().interpolate(triangle.a.position, triangle.b.position, alphaAB), new Vector2f().interpolate(triangle.a.texCoords, triangle.b.texCoords, alphaAB), new Vector3f().interpolate(triangle.a.normals, triangle.b.normals, alphaAB), new Vector3f().interpolate(triangle.a.modelPosition, triangle.b.modelPosition, alphaAB));
			Vertex AC = new Vertex(new Vector3f().interpolate(triangle.a.position, triangle.c.position, alphaAC), new Vector2f().interpolate(triangle.a.texCoords, triangle.c.texCoords, alphaAC), new Vector3f().interpolate(triangle.a.normals, triangle.c.normals, alphaAC), new Vector3f().interpolate(triangle.a.modelPosition, triangle.c.modelPosition, alphaAC));
			...
			Vertex BC = new Vertex(new Vector3f().interpolate(triangle.b.position, triangle.c.position, alphaBC), new Vector2f().interpolate(triangle.b.texCoords, triangle.c.texCoords, alphaBC), new Vector3f().interpolate(triangle.b.normals, triangle.c.normals, alphaBC), new Vector3f().interpolate(triangle.b.modelPosition, triangle.c.modelPosition, alphaBC));
			Vertex BA = new Vertex(new Vector3f().interpolate(triangle.b.position, triangle.a.position, alphaBA), new Vector2f().interpolate(triangle.b.texCoords, triangle.a.texCoords, alphaBA), new Vector3f().interpolate(triangle.b.normals, triangle.a.normals, alphaBA), new Vector3f().interpolate(triangle.b.modelPosition, triangle.a.modelPosition, alphaBA));
			...
			Vertex CA = new Vertex(new Vector3f().interpolate(triangle.c.position, triangle.a.position, alphaCA), new Vector2f().interpolate(triangle.c.texCoords, triangle.a.texCoords, alphaCA), new Vector3f().interpolate(triangle.c.normals, triangle.a.normals, alphaCA), new Vector3f().interpolate(triangle.c.modelPosition, triangle.a.modelPosition, alphaCA));
			Vertex CB = new Vertex(new Vector3f().interpolate(triangle.c.position, triangle.b.position, alphaCB), new Vector2f().interpolate(triangle.c.texCoords, triangle.b.texCoords, alphaCB), new Vector3f().interpolate(triangle.c.normals, triangle.b.normals, alphaCB), new Vector3f().interpolate(triangle.c.modelPosition, triangle.b.modelPosition, alphaCB));
